    ...
    <header className="header">
      ...
      {user && (
        <>
          ...
          <Link to="/account" className="header__item header__hoverable">
            Advertisement registration
          </Link>
          <span
            className="header__item header__hoverable"
      ...
      {!user && (
        <>
          <Link to="/login" className="header__item header__hoverable">
            Log in
          </Link>
        </>
      )}
      ...
      {advertisements.length === 0 ? (
        ...
        <main className="advertisements">
          {advertisements.map((ad) => (
            <Advertisement key={ad._id} advertisement={ad} />
          ))}
        </main>
      )}
    </>
