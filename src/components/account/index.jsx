...
import { getUserAdvertisements, deleteAdvertisement } from '../../services/advertisementService';
import "./style.scss";
    ...
    return (
        <>
            <header className="account-header">
                ...
                <button onClick={() => setIsOpen(isOpen => !isOpen)}>Advertisement registration</button>
            </header>
